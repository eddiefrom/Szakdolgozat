...
public class ModifyTextCreateController implements Initializable {
    ...
    public ModifyTextCreateController() {
    ...
    public void createScene() throws IOException {
        ...
        Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/view/teacher/ModifyTextCreateVIEW.fxml")));
