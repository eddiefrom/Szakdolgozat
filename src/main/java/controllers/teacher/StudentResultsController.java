...
public class StudentResultsController implements Initializable {
    ...
    public StudentResultsController() {
        ...
        student = studentInfoController.getStudent();
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/teacher/StudentResultsVIEW.fxml"));
        pane = loader.load();
    ...
    public void openCompetition() throws IOException {
        ...
        if(selectedWorksheet != null) {
            StudentCompInfoController studentCompInfoController = new StudentCompInfoController();
            studentCompInfoController.createScene();
        }
    }
    ...
    public void openPractice() throws IOException {
        ...
        if(selectedWorksheet != null) {
            StudentPracticeInfoController studentPracticeInfoController = new StudentPracticeInfoController();
            studentPracticeInfoController.createScene();
        }
    }
