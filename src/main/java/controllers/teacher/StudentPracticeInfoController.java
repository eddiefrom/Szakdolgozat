...
public class StudentPracticeInfoController implements Initializable {
    ...
    public StudentPracticeInfoController() {
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/teacher/StudentPracticeInfoVIEW.fxml"));
        pane = loader.load();
