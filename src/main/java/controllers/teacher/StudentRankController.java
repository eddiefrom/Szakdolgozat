...
public class StudentRankController implements Initializable {
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/teacher/StudentRankVIEW.fxml"));
        pane = loader.load();
