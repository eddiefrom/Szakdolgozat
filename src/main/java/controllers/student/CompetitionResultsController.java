...
public class CompetitionResultsController implements Initializable {
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student/CompetitionResultsVIEW.fxml"));
        pane = loader.load();
