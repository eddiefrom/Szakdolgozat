...
public class PracticeResultsController implements Initializable {
    ...
    public PracticeResultsController() {
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student/PracticeResultsVIEW.fxml"));
        pane = loader.load();
