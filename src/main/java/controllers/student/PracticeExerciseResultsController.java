...
public class PracticeExerciseResultsController implements Initializable {
    ...
    public PracticeExerciseResultsController() {
    ...
    public void createScene(Stage stage) throws IOException {
        ...
        this.stage = stage;
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student/PracticeExerciseResultsVIEW.fxml"));
        pane = loader.load();
    ...
    public  static void setActualPoints(List<Double> actualPoints) {
        PracticeExerciseResultsController.actualPoints = actualPoints;
    }
    ...
    public static void setActualTimes(List<Integer> actualTimes) {
        PracticeExerciseResultsController.actualTimes = actualTimes;
    }
