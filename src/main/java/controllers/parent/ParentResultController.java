...
public class ParentResultController implements Initializable {

    private Stage stage;
    private AnchorPane pane;

    private ParentMainController parentMainController;
    ...
    public ParentResultController() {
        ...
        student = parentMainController.getSelectedStudent();
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/parent/ParentResultVIEW.fxml"));
        pane = loader.load();
    ...
    public void openCompetition() throws IOException {
        ...
        if(selectedWorksheet != null) {
            ParentCompetitionResultController parentCompetitionResultController  =new ParentCompetitionResultController();
            parentCompetitionResultController.createScene();
        }
    }
    ...
    public void openPractice() throws IOException {
        ...
        if(selectedWorksheet != null) {
            ParentPracticeResultController parentPracticeResultController = new ParentPracticeResultController();
            parentPracticeResultController.createScene();
