...
public class ParentCompetitionResultController implements Initializable {
    ...
    public ParentCompetitionResultController() {
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/parent/ParentCompResultVIEW.fxml"));
        pane = loader.load();
