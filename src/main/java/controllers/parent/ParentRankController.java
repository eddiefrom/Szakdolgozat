...
public class ParentRankController implements Initializable {
    ...
    public void createScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/parent/ParentRankVIEW.fxml"));
        pane = loader.load();
